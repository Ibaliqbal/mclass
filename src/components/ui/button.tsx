  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-blue-600 text-slate-100 shadow-sm hover:bg-blue-600/80 dark:bg-blue-800 dark:text-slate-50 dark:hover:bg-blue-800/80",
        ghost:
          "hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-slate-800 dark:hover:text-slate-50",
        link: "text-slate-900 underline-offset-4 hover:underline dark:text-slate-50",
        icon: "text-slate-900 dark:text-slate-50",
        logout:
          "bg-red-600 text-slate-100 shadow-sm hover:bg-red-600/80 dark:bg-red-600 dark:text-slate-50 dark:hover:bg-red-600/80",
      },
      size: {
